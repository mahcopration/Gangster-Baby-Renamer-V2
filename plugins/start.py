...
ADMIN = int(os.environ.get("ADMIN", 6112399514))
bot_username = os.environ.get("BOT_USERNAME","MAH_RENAME_4GB_BOT")
...
async def send_doc(client, message):
    ...
    if update_channel:
        try:
            ...
            await client.send_message(log_channel,f"🦋 #MAHSOOM_LOGS 🦋,\n\n**ID** : `{user_id}`\n**Name**: {message.from_user.first_name} {message.from_user.last_name}\n**User-Plan** : {user}\n\n ",
